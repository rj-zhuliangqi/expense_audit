...
individual module locations.  The four official graph files intentionally stay
at the repository root because their filenames are part of the deployment and
workflow contract.
"""
...
OFFICIAL_GRAPH_PATHS: dict[str, Path] = {
    "telecom": PROJECT_ROOT / "graph-latest-0727-1900.json",
    "entertainment": PROJECT_ROOT / "graph-latest-entertainment-0722.json",
    "personal_transport": PROJECT_ROOT / "graph-latest-personal-transport-0722.json",
    "travel": PROJECT_ROOT / "graph-latest-travel-0807.json",
}
...
LEGACY_TRAVEL_RULE_SOURCE = PROJECT_ROOT / "差旅" / "差旅费-构建流程图稽核点 - Sheet1.csv"
LEGACY_ENTERTAINMENT_RULE_SOURCE = PROJECT_ROOT / "业务招待费"
LEGACY_PERSONAL_TRANSPORT_RULE_SOURCE = PROJECT_ROOT / "交通费"


def resolve_project_path(value: str | os.PathLike[str] | None, default: Path | None = None) -> Path | None:
