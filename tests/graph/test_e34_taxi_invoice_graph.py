...
class E42TaxiInvoiceGraphTests(unittest.TestCase):
    @classmethod
    ...
    @staticmethod
    def _e42(result: dict) -> dict:
        for value in result["decisionOutput"].values():
            if isinstance(value, dict) and value.get("reason_code") == "E42":
                return value
        raise AssertionError("E42 result not found")
    ...
    def test_taxi_without_hit_passes(self) -> None:
        ...
        self.assertEqual(self._e42(result)["distinguish_result"], "PASS")
